...
{
	HAL_FLASH_Unlock(); 		//Flash is unlocked for writing process


	/*
	 * Sector 7 is erased
	 * 32bits writing in progress. for reason we choose voltage 3 range
	 * */
	FLASH_Erase_Sector(FLASH_SECTOR_7, VOLTAGE_RANGE_3);

	HAL_FLASH_Program(FLASH_TYPEPROGRAM_WORD, myFlashAddress, myFlashData);

	HAL_FLASH_Lock(); 			// Flask is locked; Writing finished
}
